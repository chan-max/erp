<template>
  <div class="p-4">
    <div style="background: #fff" class="p-4 border collect-tab">
      <a-tabs v-model:activeKey="activeTab" size="small" type="card">
        <a-tab-pane key="1" tab="热销图采集">
          <div>
            <a-form
              :model="crawlerForm"
              :rules="crawlerRules"
            ...
            >
              <div class="flex flex-wrap">
                ...
                <a-form-item label="谷歌识图" name="googleImageSearch">
                  <a-radio-group
                    v-model:value="crawlerForm.googleImageSearch"
                    style="width: 180px"
                  >
                ...
                <a-form-item label="一键抠图" name="autoCutout">
                  <a-radio-group
                    v-model:value="crawlerForm.autoCutout"
                    style="width: 180px"
                  >
                    <a-radio :value="true">开启</a-radio>
                    <a-radio :value="false">关闭</a-radio>
              ...
              <div class="flex justify-end">
                ...
                <a-button
                  ...
                  >{{ crawlerLoading ? "正在处理数据，请稍等" : "确定" }}</a-button
                >
              </div>
            </a-form>
          </div>
        </a-tab-pane>
        <a-tab-pane key="2" tab="网络爬图">
          <div>
            <a-form
            ...
            >
              <div class="flex flex-wrap">
                ...
                <a-form-item
                  label="搜索词"
                  name="searchContent"
                  v-if="isCrawlerOperationUsable('searchContent')"
                >
                  <a-input
                    type="textarea"
                ...
                <a-form-item
                  label="点赞量"
                  name="likedCount"
                  v-if="isCrawlerOperationUsable('likedCount')"
                >
                  <a-input
                ...
                <a-form-item
                  label="下载量"
                  name="downloadCount"
                  v-if="isCrawlerOperationUsable('downloadCount')"
                >
                  <a-input
                    step="10"
                    min="0"
                ...
                <a-form-item
                  label="所属类目"
                  name="category"
                  v-if="isCrawlerOperationUsable('category')"
                >
                  <a-select
                    v-model:value="crawlerForm.category"
                    :options="categoryOptions"
              ...
              <div class="flex justify-end">
                <a-button @click="resetCrawlerForm">重置</a-button>
                <a-button
                  class="ml-4"
                  type="primary"
                  @click="doCrawler"
            ...
            <div v-else class="flex items-center justify-center">
              ...
              >
                <template #description>
                  <span style="font-size: 12px"> 暂无可爬取网站... </span>
                </template>
              </a-empty>
            </div>
          </div>
        </a-tab-pane>
        <a-tab-pane key="3" tab="AI 生图">
          <div class="flex items-center justify-center p-4">功能开发中...</div>
        </a-tab-pane>
      </a-tabs>
    </div>
...
watchEffect(() => {
  gridOptions.value.height = height.value - 420;
});
