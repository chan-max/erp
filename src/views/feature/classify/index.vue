<template>
  <div class="p-4">
    ...
    <div class="flex" style="column-gap: 36px">
      <div style="width: 360px; flex-shrink: 0">
        <!-- <folder-tree2></folder-tree2> -->
        <!-- <folder-tree3></folder-tree3> -->
...
import folderTree from "./tree.vue";
import folderTree2 from "./tree2.vue";
import folderTree3 from "./tree2.vue";
...
const gridOptions = ref({
  ...
  columns: [
    ...
    { title: "分类名称", field: "username", minWidth: 100 },
    {
      title: "创建时间",
      field: "createTime",
      width: 120,
